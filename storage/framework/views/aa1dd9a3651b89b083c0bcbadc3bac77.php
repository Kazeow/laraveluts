        ...
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <td class="text-center">
                <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="<?php echo e(route('customers.destroy', $customer->id)); ?>" method="POST">
                  <a href="<?php echo e(route('customers.show', $customer->id)); ?>" class="btn btn-sm btn-dark">SHOW</a>
...
<?php echo $__env->make('template.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ambar\resources\views/customers/index.blade.php ENDPATH**/ ?>